...
public static class Extensions
{
    ...
    /// <summary>
    /// Adds MCP (Model Context Protocol) server support using official SDK
    /// </summary>
    public static IMcpServerBuilder AddMCPSupport<TBuilder>(this TBuilder builder) 
        where TBuilder : IHostApplicationBuilder
    {
        // Add official MCP server with HTTP/SSE transport
        ...
        .WithHttpTransport(); // Enable HTTP/SSE transport for ASP.NET Core
    }
